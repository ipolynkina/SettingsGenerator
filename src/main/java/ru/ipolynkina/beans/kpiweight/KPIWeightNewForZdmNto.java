...
public class KPIWeightNewForZdmNto extends Parameter {

    public KPIWeightNewForZdmNto(String coefficient, String post, Boolean useWithoutCategory, Integer minCategory, Integer maxCategory,
