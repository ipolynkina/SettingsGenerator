...
public class KPIWeightNewForZdmTo extends Parameter {

    public KPIWeightNewForZdmTo(String coefficient, String post, Boolean useWithoutCategory, Integer minCategory, Integer maxCategory,
