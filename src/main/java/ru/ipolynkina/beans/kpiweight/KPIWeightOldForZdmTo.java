...
public class KPIWeightOldForZdmTo extends Parameter {

    public KPIWeightOldForZdmTo(String coefficient, String post, Boolean useWithoutCategory, Integer minCategory, Integer maxCategory,
