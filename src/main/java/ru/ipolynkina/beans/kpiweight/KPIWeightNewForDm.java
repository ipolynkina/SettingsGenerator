...
public class KPIWeightNewForDm extends Parameter {

    public KPIWeightNewForDm(String coefficient, String post, Boolean useWithoutCategory, Integer minCategory, Integer maxCategory,
