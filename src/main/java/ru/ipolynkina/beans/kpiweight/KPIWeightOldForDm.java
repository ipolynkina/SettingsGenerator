...
public class KPIWeightOldForDm extends Parameter {

    public KPIWeightOldForDm(String coefficient, String post, Boolean useWithoutCategory, Integer minCategory, Integer maxCategory,
